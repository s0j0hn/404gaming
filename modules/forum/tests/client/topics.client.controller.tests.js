    ...
    // with the same name as the service.
      ...
      // Spy on state go
        ...
        // Test URL redirection after the Reply was created
                expect($state.go).toHaveBeenCalledWith('app.topics.view', {
        ...
        // Mock Reply in $scope
            ...
            it('should update a valid Reply', inject(function (TopicsService) {
        // Set PUT response
        ...
        // Setup Topics
            ...
            it('should delete the Reply and redirect to Topics', function () {
        // Return true on confirm message
                ...
                expect($state.go).toHaveBeenCalledWith('app.topics.list');
            });

            it('should should not delete the Reply and not redirect', function () {
