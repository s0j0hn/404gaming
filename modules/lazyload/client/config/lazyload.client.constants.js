    ...
    modules: [
      ...
      { name: 'angular-rickshaw',
        ...
        ['/lib/d3/d3.min.js',
          ...
          '/lib/angular-rickshaw/rickshaw.js'],
        serie: true },
      { name: 'angular-chartist',
        files: ['/lib/chartist/dist/chartist.min.css',
          '/lib/chartist/dist/chartist.js',
          '/lib/angular-chartist.js/dist/angular-chartist.js'],
        serie: true },
      { name: 'ui.map',
        files:
      ...
      { name: 'ui-notification', files: ['/lib/angular-ui-notification/dist/angular-ui-notification.css',
        'lib/angular-ui-notification/dist/angular-ui-notification.js\','], serie: true },
      { name: 'SweetAlert2',
        files:
