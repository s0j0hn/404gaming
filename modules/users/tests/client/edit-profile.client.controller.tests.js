  ...
  describe('Edit Profile Controller Tests', function () {
    ...
    describe('Update User Profile', function () {
      ...
      it('should update the user profile', inject(function (UsersService) {
        ...
        expect(Notify.success).toHaveBeenCalledWith({ message: '<i class="glyphicon glyphicon-ok"></i> Edit profile successful!' });
      }));

      it('should call Notify.error if error', inject(function (UsersService) {
        ...
        expect(Notify.error).toHaveBeenCalledWith({ message: errorMessage, title: '<i class="glyphicon glyphicon-remove"></i> Edit profile failed!' });
      }));
    });
