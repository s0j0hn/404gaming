    ...
    describe('Logged out user', function () {
      ...
      describe('askForPasswordReset', function () {
        ...
        describe('POST error', function () {
          ...
          it('should call Notify.error with response message', function () {
            expect(Notify.error).toHaveBeenCalledWith({ message: errorMessage, title: '<i class="glyphicon glyphicon-remove"></i> Failed to send password reset email!', delay: 4000 });
          });
        });
        ...
        describe('POST success', function () {
          ...
          it('should call Notify.success with response message', function () {
            expect(Notify.success).toHaveBeenCalledWith({ message: successMessage, title: '<i class="glyphicon glyphicon-ok"></i> Password reset email sent successfully!' });
          });
        });
      });
      ...
      describe('resetUserPassword', function () {
        ...
        it('POST error should call Notify.error with response message', function () {
          ...
          expect(Notify.error).toHaveBeenCalledWith({ message: errorMessage, title: '<i class="glyphicon glyphicon-remove"></i> Password reset failed!', delay: 4000 });
        });
        ...
        describe('POST success', function () {
          ...
          it('should redirect to password reset success view with Notify.success', function () {
            expect(Notify.success).toHaveBeenCalledWith({ message: '<i class="glyphicon glyphicon-ok"></i> Password reset successful!' });
