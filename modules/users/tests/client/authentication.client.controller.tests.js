    ...
    describe('Logged out user', function () {
      ...
      describe('$scope.signin()', function () {
        ...
        it('should fail to log in with nothing', function () {
          ...
          // Test Notify.error is called
          expect(Notify.error).toHaveBeenCalledWith({ message: 'Missing credentials', title: '<i class="glyphicon glyphicon-remove"></i> Signin Error!', delay: 6000 });
        });
        ...
        it('should fail to log in with wrong credentials', function () {
          ...
          // Test Notify.error is called
          expect(Notify.error).toHaveBeenCalledWith({ message: 'Unknown user', title: '<i class="glyphicon glyphicon-remove"></i> Signin Error!', delay: 6000 });
        });
      });
      ...
      describe('$scope.signup()', function () {
        it('should register with correct data', inject(function ($templateCache) {
          ...
          expect(Notify.success).toHaveBeenCalledWith({ message: '<i class="glyphicon glyphicon-ok"></i> Signup successful!' });
        ...
        it('should fail to register with duplicate Username', function () {
          ...
          // Test Notify.error is called
          expect(Notify.error).toHaveBeenCalledWith({ message: 'Username already exists', title: '<i class="glyphicon glyphicon-remove"></i> Signup Error!', delay: 6000 });
        });
      });
    });
